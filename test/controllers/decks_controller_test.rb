...
class DecksControllerTest < ActionController::TestCase
  ...
  test "should create deck" do
    assert_difference('Deck.count') do
      post :create, deck: { active: @deck.active, description: @deck.description, name: @deck.name, public: @deck.public }
    end
  ...
  test "should update deck" do
    patch :update, id: @deck, deck: { active: @deck.active, description: @deck.description, name: @deck.name, public: @deck.public }
    assert_redirected_to deck_path(assigns(:deck))
  end
